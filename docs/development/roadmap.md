...
| 8 | Background render/export, page-level accessibility audit and release packaging (scale profiles, shared keyboard/focus baseline, production WSGI launch and liveness/readiness probes delivered) |
